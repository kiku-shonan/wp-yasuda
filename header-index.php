...
<html <?php language_attributes(); //html要素のlang属性を出力 ?>>
	...
	<meta name="keywords" content="富山, 富山初, 犬服, 犬服教室, ドッグウェアクリエイター認定講師" />
	<meta name="author" content="freehtml5.co custom by Ralph Shonan" />
	...
	<header id="fh5co-header" class="fh5co-cover js-fullheight bg-slider" role="banner" data-stellar-background-ratio="0.5">
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 text-center">
					<div class="display-t js-fullheight">
						<div class="display-tc js-fullheight animate-box" data-animate-effect="fadeIn">
							<img class="img-responsive show" src="<?php echo get_template_directory_uri(); ?>/images/logo.png"></img>
							<!--
				...
				<div id="scroll-btn" class="col-md-12 text-center">
					<a href="#fh5co-featured-testimony"><span></span>Scroll</a>
				</div>
			</div>
		</div>
	</header>
